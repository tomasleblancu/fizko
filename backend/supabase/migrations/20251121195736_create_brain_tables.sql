...
COMMENT ON COLUMN public.user_brain.extra_metadata IS 'Additional metadata stored with the memory (e.g., category)';
...
COMMENT ON COLUMN public.company_brain.extra_metadata IS 'Additional metadata stored with the memory (e.g., category)';
