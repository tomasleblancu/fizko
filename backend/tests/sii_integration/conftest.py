...
def sii_client():
    """
    Fixture that provides a shared SIIClient instance for all tests in the module.
    Automatically handles login and cleanup.
    Using module scope to avoid repeated authentication (saves ~30-40 seconds per test run).
    """
