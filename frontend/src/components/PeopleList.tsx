            ...
            {people.map((person) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                  <button className="w-full text-center py-2 text-sm font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">
                    Ver detalles
                  </button>
                </div>
              </div>
