      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">
            Únete a los primeros usuarios de Fizko. Déjanos tus datos y te
            contactaremos con acceso exclusivo.
          </p>
        </div>
        ...
        {submitSuccess && (
          <div className="mb-6 rounded-lg bg-green-50 p-4 text-green-800 dark:bg-green-900/20 dark:text-green-400">
            ¡Bienvenido al pre lanzamiento! Te contactaremos pronto con tu
            acceso exclusivo a Fizko.
          </div>
        )}
