...
export const metadata: Metadata = {
  title: 'Política de Privacidad | Fizko',
  description: 'Política de Privacidad de Fizko - cómo recopilamos, usamos y protegemos sus datos personales - última actualización enero 2025',
};
