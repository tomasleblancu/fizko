import { ArrowRight, Shield, CheckCircle2, Sparkles, Brain, Clock } from 'lucide-react';
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8">
                Solo necesitas tu RUT y contraseña. <strong>Igual que cuando entras a tu cuenta del SII</strong>, pero nosotros lo hacemos automático por ti.
              </p>

              <div className="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 mb-6">
                <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed">
                  No te preocupes por la seguridad. Usamos el mismo nivel de encriptación que los bancos (AES-256) y <strong>nunca</strong> guardamos tu contraseña en texto plano.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-slate-600 dark:text-slate-300 text-lg">
                    Traemos <strong>todas tus facturas</strong> de compra y venta
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
        ...
        <section>
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8">
                Olvídate de entrar al SII cada vez que necesitas algo. Nosotros te mostramos <strong>todo lo importante</strong> en un dashboard simple.
              </p>
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                Y si tienes más de una empresa, cambias entre ellas con un click.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8">
                Tenemos un <strong>asistente con inteligencia artificial</strong> que sabe de impuestos. Le preguntas lo que sea y te responde al tiro.
              </p>
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-300">
                  Disponible <strong>24/7</strong>, incluso fines de semana y feriados
                </p>
              </div>
              <div className="flex items-start gap-3">
        ...
        <section>
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-8">
                Te mandamos recordatorios <strong>antes</strong> de cada fecha importante. Por WhatsApp, email o donde prefieras.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
                  <p className="text-slate-600 dark:text-slate-300 text-lg">
                    Te avisamos <strong>7 días antes</strong> del vencimiento del F29
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
                  <p className="text-slate-600 dark:text-slate-300 text-lg">
                    Te alertamos si hay algo <strong>raro</strong> en tu declaración
                  </p>
                </div>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8">
                <p className="text-slate-700 dark:text-slate-300 text-lg leading-relaxed">
                  En resumen: <strong>te sacas el cacho de estar pendiente</strong> del SII. Nosotros nos preocupamos por ti.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                El mismo nivel que usan los bancos para proteger tus transacciones. Nadie puede ver tus datos, ni siquiera nosotros.
              </p>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8">
              <h3 className="font-bold text-slate-900 dark:text-white mb-3 text-xl">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                Solo <strong>leemos</strong> información del SII. No modificamos ni enviamos nada sin que tú lo apruebes primero.
              </p>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8">
              <h3 className="font-bold text-slate-900 dark:text-white mb-3 text-xl">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                Usamos hash criptográfico. Ni siquiera nuestro equipo técnico puede ver tu contraseña.
              </p>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8">
              <h3 className="font-bold text-slate-900 dark:text-white mb-3 text-xl">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                Todo lo que viaja entre tu navegador y nuestros servidores está cifrado de punta a punta.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-3xl p-8 border-2 border-emerald-200 dark:border-emerald-800">
              ...
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                Fizko te ayuda a <strong>entender tus impuestos</strong> sin necesidad de contratar a un contador. Nuestro asistente te explica todo en palabras simples.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-3xl p-8 border-2 border-blue-200 dark:border-blue-800">
              ...
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                Fizko te <strong>ahorra horas</strong> de trabajo manual. En vez de revisar facturas una por una, lo ves todo organizado automáticamente.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-3xl p-8 border-2 border-purple-200 dark:border-purple-800">
              ...
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                Fizko <strong>complementa tu trabajo</strong>. Tus clientes tienen acceso a su info en tiempo real y tú puedes revisar todo desde un solo lugar.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-10 leading-relaxed">
            Estamos en pre lanzamiento. Los primeros usuarios entran con condiciones especiales.
          </p>
